...
CREATE TABLE `order_`  (
  ...
  `status` int(255) NULL DEFAULT 0 COMMENT '支付状态，0：未支付，1：正在发货，2：已发货，3：已收货',
...
INSERT INTO `orderitem` VALUES (47, 1, NULL, 9, 1);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, '小白', '2f85a07a07497b1f3d4c0f522fbecab9', 'Odvur9FBvSlVgpYlJhz+oQ==', 1, '泉州信息工程学院', '13045924953', '2020-11-28 02:12:39');
INSERT INTO `user` VALUES (2, 'admin', '45ec20ba8f289446c041d11cbbc7e8e1', 'OqAF68Wxa5B071jnZYQYGw==', 1, '泉州信息工程学院', '13045924953', '2020-11-28 21:01:55');
