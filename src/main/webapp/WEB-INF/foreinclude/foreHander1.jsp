            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="header-top-text text-center text-lg-left mb-0 mb-md-15 mb-sm-15">
                        <p><i class="icon ion-md-alarm"></i> 下单后，40分钟内送达,投诉电话  <span class="support-no">: (+86) 13045924953</span></p>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
                    ...
                    <div class="header-top-dropdown d-flex justify-content-center justify-content-lg-end">
                        ...
                        <div class="single-dropdown">
                            ...
                            <a href="/fore/foreIndex" id="changeLanguage"><span id="languageName">首 页</span></a>
                        ...
                        <c:if test="${cst==null}">
                            <div class="single-dropdown">
                                <a href="foreLoginUI"><span>登 陆</span></a>
                            </div>
                            <span class="separator pl-15 pr-15">|</span>
                            <div class="single-dropdown">
                                <a href="foreRegisterUI"><span>注 册</span></a>
                            </div>
                        </c:if>
                        <!--=======  End of single dropdown  =======-->
                    </div>
                ...
                <div class="col-12 col-lg-3">
                    ...
                    <div class="navigation-search d-none d-lg-block">
                        <form method="post" action="/fore/foreNameLike">
                            <input type="search" placeholder="搜索商品 ..." name="pName" id="">
